...
while 1:
    ...
    #print(profile)
    #browser.get("https://licenses.storware.eu/vprotect/trial/")
    browser.get("https://licenses.storware.eu/registration/vprotect?type=TRIAL")
    #sleepy.sleep(20)
    ...
    #next_step = browser.find_element_by_id("proceedButton")
    #next_step.click()
    #sleepy.sleep(5)
    ...
    country = browser.find_element_by_xpath("/html/body/app-root/app-layout/app-registration-form/form/div/div[1]/div/div[7]/div[3]/ngx-select-dropdown/div/div/ul[2]/li")
    country.click()
